...
import { PageHeader, Table, Tag, Select, Progress, Descriptions, Form, Input, Button, Checkbox, Layout, Menu, Breadcrumb, Space, Card, Col, Row, Statistic, Calendar } from 'antd';
import "./index.scss";
